...
def draw_exp1():
    ...
    plt.bar(index + dimw, d2, width=dimw, color=color[1], label='CliqueJoin', edgecolor='k')
...
def draw_exp4():
    # DG01
    d1 = (14, 0.4, 0.8, 1.4, 1.4, 3)
    # DG03
    d2 = (55, 1, 2, 4, 4, 6)
    # DG10
    d3 = (170, 4, 7, 16, 15, 17)
    # DG30
    d4 = (1973, 11, 22, 55,	61, 48)
    # DG60
    d5 = (6282, 22, 44, 114, 207, 95)
    ...
    plt.bar(index + dimw, d2, width=dimw, color=color[1], label='DG03', edgecolor='k', hatch='///')
    plt.bar(index + 2 * dimw, d3, width=dimw, color=color[2], label='DG10', edgecolor='k', hatch='///')
    plt.bar(index + 3 * dimw, d4, width=dimw, color=color[3], label='DG30', edgecolor='k', hatch='///')
    plt.bar(index + 4 * dimw, d5, width=dimw, color=color[4], label='DG60', edgecolor='k', hatch='///')
...
def draw_exp5():
    ...
    plt.bar(index + dimw, d2, width=dimw, color=color[1], label='$q_4$', edgecolor='k')
    plt.xticks(index + dimw / 2, xticks)
    plt.xticks(fontsize=11)
    plt.yticks(fontsize=13)
    plt.ylabel('Query Time (s)', fontsize=15)
